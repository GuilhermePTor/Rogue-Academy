...
**In its first form, Rogue Academy is a website for curated AI learning resources** — a hand-picked collection of the best freely available material on the web, organized to take you from first principles to the frontier. No paywalls, no fluff, no filler.

The curriculum draws from two major tracks:

- **Physics → AI** — The first course takes an unconventional path in. Rather than starting with ML textbooks, it starts with **physics** — because the ideas powering modern AI didn't appear from nowhere. Entropy, equilibrium, energy landscapes, phase transitions, dynamical systems — these were formalized in physics long before they were repurposed for machine learning. Understanding them in their original context builds a different kind of intuition: one that transfers, generalizes, and holds up when the frameworks change.

- **Stanford CS / AI Curriculum** — Alongside the physics track, the platform curates the best of Stanford's publicly available AI and CS courses — including CS221 (Artificial Intelligence), CS229 (Machine Learning), CS231n (Deep Learning for Vision), CS224n (NLP with Deep Learning), and others. These courses represent some of the most rigorous, freely accessible AI education in the world, and serve as the academic backbone of the curriculum.
